describe('App test', () => {
  ...
  describe('Calculator test', () => {
    it('should handling addition', () => {
      ...
      cy.get('.components__KeypadButton-mu052l-0').contains('=').click();
      cy.get('.components__CalculatorDisplay-sc-17khll6-0').should(
        'have.text',
        '12',
      );
    });
    ...
    it('should show and delete history', () => {
      cy.get('.components__ControlPanelButton-z3jwdb-0')
        .contains('Show history')
        .click();
      expect(
        cy.get('.components__HistoryTitle-sc-1ydwq76-1').should('be.visible'),
      );

      cy.get('.components__ControlPanelButton-z3jwdb-0')
        .contains('Delete history')
        .click();
      cy.get('.components__HistoryElementsContainer-sc-1ydwq76-3').should(
        'be.hidden',
      );
    });
    ...
    it('should handle navigation', () => {
      cy.get('.components__NavbarLink-sc-1p8fyki-3')
        .contains('Settings')
        .click();
  ...
  describe('Settings tests', () => {
    ...
    it('should theme change', () => {
      cy.visit('/settings');
      cy.get('.components__PageLayout-sc-1txcsbk-0').should(
        'have.css',
        'background-color',
        'rgb(206, 206, 206)',
      );
